module PokemonEmeraldFactoryParticipantsHelper
  ...
  def type_effective_arr(type1, type2)
    ...
    effectiveness = {
      ...
      "くさ" => { "ほのお" => 2, "みず" => 0.5, "でんき" => 0.5, "くさ" => 0.5, "こおり" => 2, "どく" => 2, "じめん" => 0.5, "ひこう" => 2, "むし" => 2 },
      ...
      "いわ" => { "ノーマル" => 0.5, "ほのお" => 0.5, "みず" => 2, "くさ" => 2, "かくとう" => 2, "どく" => 0.5, "じめん" => 2, "ひこう" => 0.5, "はがね" => 2 },
      ...
      "はがね" => { "ノーマル" => 0.5, "ほのお" => 2, "くさ" => 0.5, "こおり" => 0.5, "かくとう" => 2, "どく" => 0, "じめん" => 2, "ひこう" => 0.5, "エスパー" => 0.5, "むし" => 0.5, "いわ" => 0.5, "ゴースト" => 0.5, "ドラゴン" => 0.5, "あく" => 0.5, "はがね" => 0.5 }
    }
